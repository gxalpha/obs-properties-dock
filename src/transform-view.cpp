...
OBSBasicTransform::OBSBasicTransform(OBSSceneItem item_)
	: ui(new Ui::OBSBasicTransform), item(item_)
{
	ui->setupUi(this);
	...
	transformSignal.Connect(sh, "item_transform", SceneItemTransformSignal,
				this);
}
